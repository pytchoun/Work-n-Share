<?php
$pageDescription = "Openspace de Beaubourg de Work'n Share.";
$pageTitle = "Work'n Share - Beaubourg";
  ...
  <body>
    ...
    <section>
      <div class="container container-main-content">
        <div class="row">
          <div class="col-md-12">
            <h1 class="text-center border-bottom border-bottom-header">Présentation de notre openspace de Beaubourg</h1>
          </div>
        </div>

        <div class="row" style="margin-top:50px;">
          <div class="col-md-12">
            <h4 class="text-center">Caractéristique de notre site de Beaubourg</h4>
          </div>
        </div>
