<?php
$pageDescription = "Openspace d'Odéon de Work'n Share.";
$pageTitle = "Work'n Share - Odéon";
  ...
  <body>
    ...
    <section>
      <div class="container container-main-content">
        <div class="row">
          <div class="col-md-12">
            <h1 class="text-center border-bottom border-bottom-header">Présentation de notre openspace d'Odéon</h1>
          </div>
        </div>

        <div class="row" style="margin-top:50px;">
          <div class="col-md-12">
            <h4 class="text-center">Caractéristique de notre site d'Odéon</h4>
          </div>
        </div>
