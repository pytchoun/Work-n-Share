<?php
$pageDescription = "Openspace de la Ternes de Work'n Share.";
$pageTitle = "Work'n Share - Ternes";
  ...
  <body>
    ...
    <section>
      <div class="container container-main-content">
        <div class="row">
          <div class="col-md-12">
            <h1 class="text-center border-bottom border-bottom-header">Présentation de notre openspace de la Ternes</h1>
          </div>
        </div>

        <div class="row" style="margin-top:50px;">
          <div class="col-md-12">
            <h4 class="text-center">Caractéristique de notre site de la Ternes</h4>
          </div>
        </div>
