<?php
$pageDescription = "Openspace la République de Work'n Share.";
$pageTitle = "Work'n Share - République";
  ...
  <body>
    ...
    <section>
      <div class="container container-main-content">
        <div class="row">
          <div class="col-md-12">
            <h1 class="text-center border-bottom border-bottom-header">Présentation de notre openspace de la République</h1>
          </div>
        </div>

        <div class="row" style="margin-top:50px;">
          <div class="col-md-12">
            <h4 class="text-center">Caractéristique de notre site de la République</h4>
          </div>
        </div>
        ...
        <div class="row text-center" style="margin-top:50px;">
          <div class="col-md-3">
						<img src="assets/image/illustration/ordinateur_portable.svg" alt="Support Work'n Share" height="80">
						<p style="padding-top:20px;">
